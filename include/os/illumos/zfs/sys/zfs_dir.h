...
/*
 * Directory entry locking (illumos uses the full dirent_lock interface
 * with a pathname_t for case-folding support).
 */
...
extern void zfs_dl_name_switch(zfs_dirlock_t *dl, char *new_name,
    char **old_name);
